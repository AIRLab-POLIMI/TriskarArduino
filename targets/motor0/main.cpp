...
SpeedPID::ConfigurationType       pid_configuration_default;
...
SpeedPID              pid_node("speed", hbridge, core::os::Thread::PriorityEnum::NORMAL);
...
extern "C" {
    ...
    main()
    {
        ...
        encoder_publisher_configuration_default.topic = "encoder_0";
        i_publisher_configuration_default.topic       = "i_0";
        pid_configuration_default.kp = 0.15;
        pid_configuration_default.ti = 0.037;
        pid_configuration_default.td = 0;
        pid_configuration_default.ts = period/1000.0;
        pid_configuration_default.min = -pwmMax;
        pid_configuration_default.max = pwmMax;
        pid_configuration_default.encoder_topic = "encoder_0";
        pid_configuration_default.setpoint_topic = "speed_0";
        pid_configuration_default.idle = 0;
        pid_configuration_default.timeout = 500;
        ...
        module.configurations().add(pid_node, pid_configuration_default);
