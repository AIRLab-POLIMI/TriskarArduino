...
extern "C" {
    ...
    main()
    {
        ...
        encoder_publisher_configuration_default.topic = "encoder_2";
        i_publisher_configuration_default.topic       = "i_2";
        ...
        pid_configuration_default.encoder_topic = "encoder_2";
        pid_configuration_default.setpoint_topic = "speed_2";
